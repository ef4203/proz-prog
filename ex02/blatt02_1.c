...
int main()
{
    ...
    /* Declares a_u16, b_u16, c_u16 as an unsigned 16 bit integer. */
    ...
    /* Sets b_u16 to the value of -222, which doesn't really work,
       because b_u16 is an unsigned integer, so it gets set to 65314 instead. */
    b_u16 = -222;
    ...
    /* Stores the result of a_32 * b_32 into c_32,
       and sets c_16 to the value of c_32.
       This causes an integer overflow in c_16. */
    c_16 = c_32 = a_32 * b_32;
